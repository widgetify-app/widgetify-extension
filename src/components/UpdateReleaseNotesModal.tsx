...
const VERSION_NAME = 'لیلا'
const SUMMARY =
	'در این نسخه از ویجتی‌فای، ویجت جدید "ویجی پد" اضافه شده است. امکان جابجایی ویجت‌ها با یکدیگر و فعالسازی همه ویجت‌ها بدون محدودیت فراهم شده است. همچنین بهبودهایی در تم‌ها و رنگ‌بندی سیستم، مناسبت‌ها و ویجی نیوز اعمال شده و مشکل بارگیری اخبار رفع شده است.'
const releaseNotes: ReleaseNote[] = [
	{
		type: 'feature',
		description: '📝 اضافه شدن ویجت جدید "ویجی پد"',
	},
	{
		type: 'feature',
		description: '🔄 اضافه شدن امکان جابجایی ویجت‌ها با یکدیگر',
	},
	{
		type: 'feature',
		description: '🔓 اضافه شدن قابلیت فعالسازی همه ویجت‌ها بدون محدودیت',
	},
	{
		type: 'feature',
		description: '🔍 اضافه شدن امکان فیلتر و اولویت در ویجی نیوز',
	},
	{
		type: 'improvement',
		description: '🎨 بهبود تم‌ها و رنگ‌بندی سیستم',
	},
	{
		type: 'improvement',
		description: '🎉 بهبود مناسبت‌ها',
	},
	{
		type: 'improvement',
		description: '📰 بهبود ویجی نیوز',
	},
	{
		type: 'bugfix',
		description: '🔧 رفع مشکل بارگیری اخبار در ویجی نیوز',
	},
	{
		type: 'info',
		description:
