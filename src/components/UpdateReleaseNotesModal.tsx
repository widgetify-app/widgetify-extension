...
const VERSION_NAME = 'سیمرغ'
const SUMMARY = `در این نسخه از ویجتی‌فای، فیچر مرغ برای بخش حیوان خانگی و خرچنگ 
							اضافه شده است. همچنین مشکل تغییر ایکون دلخواه بوکمارک‌ها برطرف شده و 
							قسمت انتخاب استیکر برای بوکمارک بهبود یافته است.`
const releaseNotes: ReleaseNote[] = [
	{
		type: 'feature',
		description: '🐔 اضافه شدن مرغ به بخش حیوان خانگی',
	},
	{
		type: 'feature',
		description: '🦀 اضافه شدن خرچنگ به بخش حیوان خانگی',
	},
	{
		type: 'bugfix',
		description: '🔄 رفع مشکل تغییر ایکون دلخواه بوکمارک‌ها',
	},
	{
		type: 'improvement',
		description: '🌟 بهبود قسمت انتخاب استیکر برای بوکمارک',
	},
	{
		type: 'info',
