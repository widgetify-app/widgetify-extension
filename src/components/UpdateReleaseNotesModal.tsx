...
const releaseNotes: ReleaseNote[] = [
	{
		title: 'اضافه شدن ابزار مترجم (ویجت ابزارها)',
		type: 'feature',
		description:
			'ابزار مترجم به ویجت ابزارها اضافه شد. اکنون می‌توانید متن‌ها را به راحتی ترجمه کنید.',
	},
	{
		title: 'اضافه شدن ابزار مبدل ارزها (ویجت ابزارها)',
		type: 'feature',
		description:
			'ابزار مبدل ارزها به ویجت ابزارها اضافه شد. اکنون می‌توانید نرخ تبدیل ارزهای مختلف را مشاهده کنید.',
	},
	{
		title: 'اضافه شدن تم یخی',
		type: 'feature',
		description: 'برای تجربه این تم زیبا، به تنظیمات افزونه مراجعه کنید.',
	},
	{
		title: 'اضافه شدن حالت های ماهانه، هفتگی، روزانه به برترین های پودرمودر تایمر',
		type: 'feature',
		description:
			'اکنون می‌توانید برترین‌های پودرمودر تایمر را بر اساس بازه‌های زمانی مختلف مشاهده کنید.',
	},
	{
		title: 'بازطراحی ویجت آب و هوا',
		type: 'improvement',
		description:
			'ویجت آب و هوا با طراحی جدید و امکانات بیشتر، تجربه بهتری را برای شما فراهم می‌کند.',
	},
	{
