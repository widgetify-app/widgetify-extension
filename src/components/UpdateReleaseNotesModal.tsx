...
const VERSION_NAME = '🍕 پیـتزا (2)'
const releaseNotes: ReleaseNote[] = [
	{
		type: 'feature',
		title: 'اضافه شدن فونت پوفـک',
		description: 'فونت پوفک اضافه شد. برای تغییر فونت به تنظیمات افزونه مراجعه کنید.',
	},
	{
		type: 'improvement',
		title: 'بهبود در پودمورو تایمر',
		description: 'اضافه شدن آلارم به پومودورو تایمر و بهبود تجربه کاربری آن.',
	},
	{
		type: 'feature',
	...
	{
		type: 'improvement',
		title: 'بهبود تقویم ها در ویجی پد',
		description: '',
	},
	{
		type: 'improvement',
	...
	{
		type: 'bugfix',
		title: 'رفع مشکل نمایش وظایف',
		description: 'مشکل نمایش وظایف برطرف شد.',
	},
]
