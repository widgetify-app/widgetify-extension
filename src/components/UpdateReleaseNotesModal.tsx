...
const releaseNotes: ReleaseNote[] = [
	...
	{
		title: 'اضافه شدن ابزار مبدل ارزها',
		type: 'feature',
		description:
	...
	{
		title: 'اضافه شدن حالت های ماهانه، هفتگی، روزانه به برترین های پومودورو تایمر',
		type: 'feature',
		description:
			'اکنون می‌توانید برترین‌های پومودورو تایمر را بر اساس بازه‌های زمانی مختلف مشاهده کنید.',
	},
	{
