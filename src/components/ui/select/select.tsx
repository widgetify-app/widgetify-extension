...
const triggerClass =
	'flex items-center justify-between gap-2 w-fit min-w-[5.5rem] max-w-full px-2.5 py-1.5 rounded-xl cursor-pointer select-none text-[10px] text-content bg-hovered border border-subtle transition-ui hover:bg-hovered focus-visible:focus-ring disabled:cursor-not-allowed disabled:opacity-50'
