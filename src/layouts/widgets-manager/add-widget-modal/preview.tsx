...
export function AddWidgetPreview({
	...
	return (
		<div
			...
			className="flex-1 flex flex-col items-center justify-center p-3 rounded-2xl bg-subtle text-ghost border border-subtle overflow-hidden relative min-h-47.5"
		>
