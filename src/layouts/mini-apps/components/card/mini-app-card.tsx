	...
	return (
		<div
			...
			className={`
                ...
                border ${
					isSelected
						? `border-brand-muted bg-linear-to-t from-brand-subtle via-brand-subtle to-transparent shadow-md shadow-brand-subtle`
						: `border-faint bg-content bg-glass! hover:bg-brand-subtle hover:border-brand-subtle`
				}
            `}
		>
			<div
