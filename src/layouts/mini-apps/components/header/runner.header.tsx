		...
		<div className="sticky top-0 z-10 w-full border-b border-faint">
			<div className="relative flex items-center justify-between px-4 py-3">
				<div className="flex items-center gap-2">
					<button
						className="flex items-center justify-center w-8 h-8 transition-all duration-200 border rounded-lg cursor-pointer bg-subtle active:scale-95 group border-faint"
						aria-label="بازگشت"
					...
					<div className="flex items-center gap-2.5">
						...
						{isLoadingApp && (
							<div className="rounded-lg w-7 h-7 skeleton bg-muted shrink-0" />
						)}

						<div>
							{isLoadingApp ? (
								<div className="w-24 h-3.5 rounded-full skeleton bg-muted" />
							) : (
				...
				<div className="flex gap-1">
					<button
						...
						className="flex items-center justify-center w-8 h-8 transition-all duration-200 border rounded-lg cursor-pointer bg-subtle active:scale-95 group border-faint disabled:opacity-(--disabled-opacity)"
					>
						{isFullScreen ? (
							<Icon
								name="minimize"
