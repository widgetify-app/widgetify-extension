	...
	return (
		<div className="grid w-full max-w-5xl grid-cols-1 gap-4 mx-auto md:grid-cols-3">
			{[1, 2, 3, 4, 5, 6].map((i) => (
				<div
					key={i}
					className="flex flex-col gap-4 p-5 rounded-2xl bg-subtle bg-content bg-glass"
				>
	...
	return (
		<div className="flex flex-row w-full h-screen overflow-hidden ">
			<div className="flex flex-col w-full h-full gap-2 px-2 py-3 overflow-hidden">
				{isLoading ? (
					<div className="sticky top-0 z-50 flex items-center w-full max-w-6xl mx-auto gap-2 p-1.5 overflow-x-auto bg-subtle backdrop-blur-xl rounded-2xl border border-content elevation-sm scrollbar-none flex-nowrap">
						{[1, 2, 3, 4, 5, 6].map((i) => (
							<div
								key={i}
					...
					<div className="sticky top-0 z-50 w-full max-w-6xl px-1 mx-auto">
						<div className="relative flex items-center">
							<div className="flex items-center w-full gap-1 p-1 overflow-x-auto border elevation-md bg-widget backdrop-blur-2xl rounded-2xl border-content scrollbar-none flex-nowrap">
