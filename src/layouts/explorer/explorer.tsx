	...
	return (
		<div className="flex flex-row w-full h-screen overflow-hidden">
				...
				<div className="flex flex-col items-center w-full gap-2 px-2 py-2 overflow-x-hidden overflow-y-auto scrollbar-none">
					{isLoading
						? [1, 2, 3, 4, 5, 6].map((i) => (
								<div
									key={i}
									className="skeleton w-14 h-14 rounded-3xl opacity-20 shrink-0"
								></div>
							))
			...
			<div className="flex flex-col w-full h-full gap-3 px-2 py-3 overflow-hidden md:px-10">
				{isLoading ? (
					<div className="md:hidden sticky top-0 z-50 flex items-center w-full gap-2 p-1.5 bg-base-100/80 backdrop-blur-xl rounded-2xl border border-white/10 overflow-x-auto">
						{[1, 2, 3, 4].map((i) => (
							<div
								key={i}
