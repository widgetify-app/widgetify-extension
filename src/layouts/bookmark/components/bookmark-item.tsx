			...
			>
				{onMenuClick && bookmark && (
					<div
						...
						className={
							'absolute cursor-pointer top-1 right-1.5 p-1 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-raised z-10'
						}
					>
				...
				<div className="absolute inset-0 transition-opacity duration-300 opacity-0 pointer-events-none group-hover:opacity-100 bg-raised rounded-widget" />
			</button>
		</div>
	)
})
