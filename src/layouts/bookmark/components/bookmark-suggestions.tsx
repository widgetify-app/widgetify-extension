				...
				<div className="grid grid-cols-5 gap-2 mt-1 py-1 max-h-24 overflow-y-auto">
					{suggestions.map((suggestion, index) => (
						<button
							...
							className="p-1.5 flex flex-col items-center justify-center text-center transition-all duration-200 bg-content hover:bg-primary/10 hover:border-primary/30 h-14 border border-subtle rounded-xl cursor-pointer"
						>
