				...
				<article className="pb-4 border-b blog-post border-content animate-fade-in animate-slide-up">
					...
					<div className="mt-2">
						<p className="leading-relaxed text-justify text-muted">
							برای وارد کردن بوکمارک‌های مرورگر به ویجتی‌فای، بعد از تایید
							کردن این پیام، یک پیغام به شکل زیر روی صفحه شما ظاهر می‌شود که
							باید روی دکمه{' '}
							<span className="font-semibold text-content">"Allow"</span>{' '}
							کلیک کنید.{' '}
						</p>
					</div>
				</article>
