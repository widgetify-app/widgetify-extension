			...
			<div className="relative inline-flex group">
				<button
					...
					className={`relative shrink-0 flex items-center justify-center cursor-pointer border-2 transition-all duration-200 ${containerSizeClasses} ${
						isDragging
							? 'border-primary bg-primary/10 elevation-lg'
							: 'border-subtle hover:border-primary/50 bg-content hover:bg-content'
					}`}
				...
				{Boolean(value) && (
					<button
						...
						className="absolute -top-1 -right-1 flex items-center justify-center w-4.5 h-4.5 rounded-full bg-error text-error-content text-[10px] leading-none elevation-md hover:scale-110 active:scale-95 transition-transform cursor-pointer z-10 border border-content"
						title="حذف آیکون"
					>
