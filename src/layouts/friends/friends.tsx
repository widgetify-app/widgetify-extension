				...
				<div className="flex items-center justify-between px-4">
					...
					<div className="flex items-center gap-2">
						...
						<button
							...
							className="flex items-center gap-2 px-3 py-1.5 transition-all border shadow-sm cursor-pointer rounded-xl bg-primary border-brand-hover text-brand border-content active:scale-95"
