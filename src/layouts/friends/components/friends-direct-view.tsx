			...
			<div className="flex items-center justify-between px-2 pt-2.5 pb-1.5 shrink-0">
				...
				<div className="flex items-center gap-1.5">
					...
					<button
						...
						className="flex items-center justify-center w-8 h-8 transition-all rounded-xl bg-subtle hover:bg-muted active:scale-90 cursor-pointer border border-subtle text-content hover:text-strong"
						title="افزودن دوست"
				...
				{isLoading ? (
					<div className="space-y-1.5 pt-1">
						{Array.from({ length: 4 }).map((_, i) => (
							<div
								key={i}
								className="flex items-center justify-between p-2 rounded-xl border border-faint bg-subtle animate-pulse"
							>
					...
					<>
						{allFriends.map((friend) => (
							<div
								...
								className="group flex items-center justify-between p-2 transition-colors duration-150 rounded-xl hover:bg-muted border border-transparent hover:border-faint cursor-pointer"
							>
								...
								<div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
									<button
										...
										className="p-1 text-faint hover:text-error hover:bg-error/10 rounded-lg transition-colors cursor-pointer"
										title="حذف دوست"
									>
