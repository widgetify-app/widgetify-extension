...
export const TrendItemComponent = ({
	...
	if (isLoading) {
		return (
			<m.div
				...
				className={'flex items-center p-1 rounded-lg bg-content h-6'}
			>
	...
	return (
		<m.div
			...
			className={
				'flex items-center px-1.5 py-1 cursor-pointer transition-colors border border-content rounded-lg bg-content h-6 hover:!bg-gray-300/10'
			}
			onClick={onClick}
		>
