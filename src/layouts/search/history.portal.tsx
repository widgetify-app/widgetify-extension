...
export function SearchHistoryPortal({
	...
	return (
		<div
			ref={portalRef}
			className="absolute left-0 w-full mt-1 overflow-hidden duration-300 shadow-2xl top-full z-60 bg-content bg-glass rounded-2xl animate-in fade-in slide-in-from-top-2 backdrop-blur-2xl"
		>
