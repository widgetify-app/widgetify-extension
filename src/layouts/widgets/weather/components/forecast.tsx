		...
		<ul className="flex justify-between w-full gap-0.5">
			{forecast.map((item) => {
				...
				return (
					<li
						key={item.date}
						className="flex flex-col items-center justify-between w-16 py-1 gap-2 transition-ui border rounded-2xl bg-base-content/5 border-content hover:bg-base-content/10"
					>
						<time
