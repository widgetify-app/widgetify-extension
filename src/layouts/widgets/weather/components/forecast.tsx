		...
		<ul className="flex justify-between w-full gap-0.5">
			{forecast.map((item) => {
				...
				return (
					<li
						key={item.date}
						className="flex flex-col items-center justify-between w-16 py-1 gap-2 transition-ui border rounded-2xl bg-base-content/2 border-base-content/5 hover:bg-base-content/10"
					>
						<time
