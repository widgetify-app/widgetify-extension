				...
				<div className="flex items-center justify-between min-w-0 flex-1">
					...
					>
						<button
							...
							className="flex items-center justify-center rounded-full w-7 h-7 text-muted opacity-70 transition-ui hover:opacity-100 hover:bg-hovered focus-visible:focus-ring"
						>
			...
			<section className="flex flex-col gap-2">
				...
				>
					{PET_BACKGROUND_LIST.map((item) => (
						...
						>
							<div
								className="flex items-center justify-center w-full h-12 bg-hovered"
								style={
									item.image
										? {
