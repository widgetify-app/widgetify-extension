			...
			<section className="flex items-center gap-3 p-3 border rounded-2xl border-content bg-subtle">
				...
				<div className="flex items-center justify-between min-w-0 flex-1">
					<div className="flex items-center gap-2 min-w-0">
						...
						<span className="px-2 py-0.5 text-[10px] leading-[1.7] border rounded-full text-content border-content bg-muted">
					...
					>
						<button
							...
							className="flex items-center justify-center rounded-full w-7 h-7 text-muted opacity-70 transition-ui hover:opacity-100 hover:bg-muted focus-visible:focus-ring"
						>
			...
			<section className="flex flex-col gap-2">
				...
				>
					{PET_BACKGROUND_LIST.map((item) => (
						...
						>
							<div
								className="flex items-center justify-center w-full h-12 bg-muted"
								style={
									item.image
										? {
