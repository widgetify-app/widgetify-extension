		...
		<div className="flex items-center justify-between w-full h-full px-3.5 py-2 select-none">
					...
					<>
						...
						<span
							className={cn(
								...
								nextPending.completed && 'line-through text-muted opacity-70'
							)}
						>
							{nextPending.text}
						</span>
			...
			{isAuthenticated && (
				<div className="flex items-center gap-2 text-xs shrink-0">
					<div className="flex items-center gap-1 px-2 py-0.5 rounded-lg bg-base-content/5 text-content border border-base-content/10 text-[11px]">
