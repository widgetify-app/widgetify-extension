...
const FlipUnit = memo(function FlipUnit({ value }: FlipUnitProps) {
	...
	return (
		...
		>
			<div
				className="absolute inset-x-0 top-0 flex items-end justify-center overflow-hidden border-b bg-content bg-glass border-subtle"
				style={{
					height: 'var(--flip-h)',
					borderRadius:
			...
			{flipping === 'top' && (
				...
				>
					<div
						className="absolute inset-0 flex items-end justify-center border-b bg-content border-subtle"
					...
					>
						...
						<div className="absolute inset-0 bg-gradient-to-b from-transparent to-(--surface-strong)" />
					</div>
				</div>
			)}
			{flipping === 'bottom' && (
				...
				>
					...
					>
						...
						<div className="absolute inset-0 bg-gradient-to-b from-(--surface-strong) to-transparent" />
					</div>
				</div>
			)}
			<div
				className="absolute inset-x-0 z-30 bg-muted"
