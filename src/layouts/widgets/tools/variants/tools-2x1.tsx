		...
		>
			{TOOLS_TABS.map((tab) => (
				<button
					...
					className="flex flex-col items-center justify-center gap-1 p-1.5 border rounded-xl cursor-pointer bg-base-content/5 border-base-content/10 transition-ui hover:bg-base-content/10 focus-visible:focus-ring"
				>
					<Icon
						name={tab.icon}
