		...
		>
			{TOOLS_TABS.map((tab) => (
				<button
					...
					className="flex flex-col items-center justify-center gap-1 p-1.5 border rounded-xl cursor-pointer bg-subtle border-subtle transition-ui hover:bg-muted focus-visible:focus-ring"
				>
					<Icon
						name={tab.icon}
