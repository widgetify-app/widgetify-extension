			...
			<div className="relative flex flex-col gap-6 p-5 border bg-subtle border-subtle rounded-2xl">
				<div className="flex items-center justify-between gap-3">
					...
					<SelectBox
						...
						className="!w-24 !h-11 rounded-2xl! !bg-widget border border-content elevation-sm font-bold text-xs"
					/>
				</div>
				...
				<div className="absolute z-10 -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
					<button
						...
						className="flex items-center justify-center border rounded-full elevation-lg cursor-pointer bg-content w-11 h-11 border-primary/10 text-content transition-ui hover:text-primary active:scale-90 hover:scale-105 backdrop-blur-md focus-visible:focus-ring"
					>
				...
				<div className="flex items-center justify-between gap-3 mt-1">
					...
					<SelectBox
						...
						className="!w-24 !h-11 !rounded-2xl  border border-primary/20 elevation-sm font-bold text-xs"
					/>
				</div>
			</div>
