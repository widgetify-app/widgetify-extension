				...
				<div className="flex gap-0.5 items-center">
					...
					{showTodayButton && (
						<button
							...
							className="flex items-center justify-center rounded-full cursor-pointer h-7 w-7 text-muted opacity-70 transition-ui hover:bg-raised hover:opacity-100 focus-visible:focus-ring"
						>
