			...
			<div className="flex items-center justify-between w-full min-w-0">
				{onRefresh && (
					<Button
						...
						className="flex items-center justify-center w-5 h-5 p-0 border-none rounded-md cursor-pointer text-muted transition-ui opacity-0 hover:text-strong hover:bg-muted group-hover:opacity-100 focus-visible:focus-ring"
