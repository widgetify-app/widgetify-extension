...
export const NewsItem = ({
	...
	return (
		<div className="transition-all">
			<div
				className="p-2 transition-all duration-300 border rounded-lg cursor-pointer border-base-300/70 active:scale-98 hover:bg-base-200/80 hover:border-base-300/90"
				onClick={handleClick}
			>
