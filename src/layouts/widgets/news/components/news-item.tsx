...
export const NewsItem = ({
	...
	return (
		<a
			...
			onClick={() => onOpen(url)}
			className="group flex items-center gap-2 p-1.5 rounded-xl cursor-pointer bg-strong/[0.03] hover:bg-strong/[0.08] transition-all border border-transparent hover:border-subtle active:scale-[0.99] focus-visible:focus-ring shrink-0"
		>
			{hasImage && (
				<img
					src={image_url}
