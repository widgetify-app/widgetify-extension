...
export function CanvasEditToolbar({
	...
	return createPortal(
		<div className="fixed bottom-2 left-1/2 -translate-x-1/2 z-70 flex items-center gap-3 px-4 py-2 rounded-2xl bg-content backdrop-blur-xl border border-subtle elevation-2xl animate-in slide-in-from-bottom-5 fade-in duration-200 select-none">
			...
			<div className="flex items-center gap-1.5">
				<button
					type="button"
					onClick={onAddWidget}
					className="px-3 py-1.5 text-xs font-bold rounded-xl bg-primary text-primary-content hover:bg-primary/90 active:scale-95 transition-all flex items-center gap-1 cursor-pointer elevation-sm whitespace-nowrap"
				>
					<span>+</span>
