...
const VIP_FEATURES: VipFeatureItem[] = [
	{
		...
		icon: 'appsPlus',
		title: 'چیدمان بدون محدودیت',
		description:
			'هر تعداد ویجت که می‌خوای اضافه کن و چند نسخه از یک ویجت رو کنار هم داشته باش',
	},
	{
		...
		description:
			'همه ویجت‌ها، اندازه‌ها و طرح‌های ویژه رو بدون محدودیت در اختیارت داشته باش',
	},
	{
