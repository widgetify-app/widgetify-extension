...
export function VipTab() {
	...
	return (
		<div className="flex flex-col w-full max-w-4xl px-2 py-2 mx-auto space-y-5 text-right select-none sm:px-4">
				...
				{isLoading ? (
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
						{Array.from({ length: 2 }).map((_, i) => (
							<div
								key={i}
								className="border rounded-2xl border-subtle bg-subtle p-4 space-y-2.5 min-h-27.5"
							>
					...
					<div className="flex flex-col items-center justify-center py-6 text-center border rounded-2xl border-subtle bg-subtle">
			...
			<div className="p-3.5 rounded-2xl border border-subtle bg-subtle flex flex-col sm:flex-row items-center justify-between gap-3">
