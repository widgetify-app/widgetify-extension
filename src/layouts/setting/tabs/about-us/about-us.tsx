			...
			<SectionPanel title="ارتباطات و شبکه های اجتماعی">
				<div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
					<a
						...
						className="flex items-center justify-between p-4 transition-all duration-200 border group rounded-4xl border-subtle bg-content hover:bg-content hover:border-brand-subtle"
					>
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="flex items-center justify-between p-4 transition-all duration-200 border group rounded-4xl border-subtle bg-content hover:bg-content hover:border-info-subtle"
					>
						<div className="flex items-center gap-3">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="flex items-center justify-between p-4 transition-all duration-200 border group rounded-4xl border-subtle bg-content hover:bg-content hover:border-success-subtle"
					>
						<div className="flex items-center gap-3">
