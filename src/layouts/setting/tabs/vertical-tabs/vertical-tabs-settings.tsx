				...
				<div className="flex items-start gap-4">
					...
					<div className="flex-1">
						...
						<p className="mb-4 text-sm leading-relaxed text-muted">
							مشاهده و مدیریت تب‌های باز در یک پنل کناری زیبا. این قابلیت به
							شما امکان می‌دهد تب‌های خود را به راحتی جابجا کرده، ببندید،
							گروه‌بندی کنید و سایت‌های مورد علاقه خود را ذخیره کنید.
						</p>
