...
export default function LoginGoogleButton() {
	...
	return (
		<button
			...
			onClick={loginGoogle}
			disabled={isLoading}
			className="w-full h-11 px-4 rounded-xl text-xs md:text-sm font-medium flex items-center justify-center border border-content bg-widget hover:bg-content active:scale-[0.99] transition-all duration-150 gap-2.5 cursor-pointer text-content shadow-xs"
		>
