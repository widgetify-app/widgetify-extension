...
export function VipBannerCard({
	...
	return (
		<div
			onClick={handleClick}
			className={`w-full flex items-center justify-between p-3.5 sm:p-4 rounded-2xl border border-vip-muted bg-content hover:bg-content hover:border-vip-muted transition-all duration-200 cursor-pointer shadow-xs group ${className}`}
		>
