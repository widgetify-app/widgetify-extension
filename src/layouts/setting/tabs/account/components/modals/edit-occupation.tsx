			...
			<div className="flex flex-col justify-between h-40 gap-4">
				<SectionPanel title="چه‌کاره‌ای؟" size="xs">
					<OccupationSelector
						...
						triggerElement={
							<div className="flex items-center justify-between w-full h-12 p-3 transition-colors border cursor-pointer border-content rounded-xl hover:border-brand-subtle!">
