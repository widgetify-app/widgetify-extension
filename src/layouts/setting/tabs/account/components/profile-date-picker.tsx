	...
	return (
		<Dropdown
			trigger={
				...
				>
					<div
						className={`flex items-center justify-between w-full h-12 p-3 transition-colors border  border-content rounded-xl  ${!enable ? 'opacity-50 cursor-not-allowed' : 'hover:border-brand-strong! cursor-pointer'}`}
					>
