...
export const ProfileDisplay = () => {
	...
	return (
		<div className="flex flex-col space-y-4">
			...
			<div className="overflow-hidden border border-subtle rounded-2xl bg-subtle">
				<DisplayRow
...
const DisplayRow = ({
	...
	return (
		<div className="flex items-center justify-between p-2 transition-colors border-b last:border-b-0 border-subtle hover:bg-subtle">
			<div className="flex items-center gap-3">
				<div className="relative flex items-center justify-center w-7 h-7 rounded-xl bg-subtle">
					{icon}
					{showBadge && (
