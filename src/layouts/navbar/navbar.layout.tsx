			...
			<nav className="flex items-center justify-between px-4 mt-0.5 md:mt-1.5">
				...
				<div className="flex items-center gap-2">
					...
					<Tooltip content="تنظیمات">
						<div
							className="flex items-center justify-center w-8 h-8 gap-2 px-1 overflow-hidden transition-all border cursor-pointer border-content rounded-xl bg-content backdrop-blur-sm hover:opacity-80 hover:scale-105"
							onClick={() => setShowSettings(true)}
						>
							<CiSettings size={22} className="text-muted" />
						</div>
					</Tooltip>
				</div>
			</nav>
